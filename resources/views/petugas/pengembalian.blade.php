		...
		<div class="lg:col-span-2 flex flex-col min-h-0 gap-4 h-full">
			...
			<div class="p-4 border border-gray-300 rounded-[20px] bg-white shadow-lg flex flex-col flex-1 overflow-hidden h-full">
							...
							<div class="flex items-center gap-4">
								<div class="flex flex-col items-end gap-1">
									...
									<div class="flex items-center gap-1.5 font-bold text-gray-800">
										...
										<span class="text-base">00:00:00</span>
									</div>
								</div>
								<button type="button" class="px-4 py-2 bg-[#363062] border border-transparent text-white rounded-full text-sm hover:bg-transparent hover:border-[#363062] hover:text-[#363062] transition-colors whitespace-nowrap">
									Terima pengembalian
								</button>
							</div>
						</div>
						...
						<div class="flex justify-between items-center w-full gap-4">
							...
							<div class="flex items-center gap-4">
								<div class="flex flex-col items-end gap-1">
									<span class="text-xs font-bold text-gray-500">Utility Desktop</span>
									<div class="flex items-center gap-1.5 font-bold text-gray-800">
										<span class="text-base">00:05:45</span>
									</div>
								</div>
								<button type="button" class="px-4 py-2 bg-white border border-[#363062] text-[#363062] rounded-full text-sm opacity-60 whitespace-nowrap">
									Terima pengembalian
								</button>
							</div>
						</div>
				...
				<div class="flex-shrink-0 -mx-4 px-4 mt-4 pt-4 border-t border-gray-500 flex gap-4">
					<button class="flex-1 py-3 border-2 border-transparent bg-[#363062] text-white rounded-full font-bold hover:bg-[#4D4C7D] transition-colors shadow-md opacity-60">
