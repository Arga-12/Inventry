    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 mt-4 overflow-y-auto scrollbar-hide">
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('peminjam-peminjaman') }}" class="group flex items-center gap-3 px-4 py-3 rounded-full border border-transparent transition-all {{ request()->routeIs('peminjam-peminjaman') ? 'bg-[#363062] text-white shadow-md' : 'text-[#4D4C7D] hover:bg-white hover:text-[#363062] hover:shadow-sm hover:border-[#363062] opacity-80' }}">
                ...
                <li>
                    <a href="{{ route('profil-edit') }}" class="group flex items-center gap-3 px-4 py-3 rounded-full border border-transparent transition-all {{ request()->routeIs('profil-edit') ? 'bg-[#363062] text-white shadow-md' : 'text-[#4D4C7D] hover:bg-white hover:text-[#363062] hover:shadow-sm hover:border-[#363062] opacity-80' }}">
        ...
        <nav class="flex-1 px-4 mt-4 overflow-y-auto scrollbar-hide">
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('admin-pengguna') }}" class="group flex items-center gap-3 px-4 py-3 rounded-full border border-transparent transition-all {{ request()->routeIs('admin-pengguna', 'admin-pengguna-create', 'admin-pengguna-edit') ? 'bg-[#363062] text-white shadow-md' : 'text-[#4D4C7D] hover:bg-white hover:text-[#363062] hover:shadow-sm hover:border-[#363062] opacity-80' }}">
                ...
                <li>
                    <a href="{{ route('admin-log') }}" class="group flex items-center gap-3 px-4 py-3 rounded-full border border-transparent transition-all {{ request()->routeIs('admin-log') ? 'bg-[#363062] text-white shadow-md' : 'text-[#4D4C7D] hover:bg-white hover:text-[#363062] hover:shadow-sm hover:border-[#363062] opacity-80' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                        </svg>
