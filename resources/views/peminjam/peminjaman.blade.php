...
<div class="mx-auto py-8 px-4">
    <div class="flex flex-col mb-8">
        <h1 class="text-4xl font-bold">Peminjaman Saya</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="flex flex-col gap-4">
            <div class="flex items-center justify-between mb-2">
                <h2 class="text-2xl font-bold">Menunggu Persetujuan</h2>
                <div class="flex items-center gap-2">
                    <div class="h-2 w-2 bg-yellow-500 rounded-full"></div>
                    <span class="text-sm text-gray-500">{{ $menunggu->count() }} Peminjaman</span>
                </div>
            </div>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <div x-data="{ open: false }" class="relative inline-block text-left">
                        ...
                        <div x-show="open" @click.outside="open = false" x-cloak x-transition.opacity
                            class="absolute left-0 z-20 mt-2 w-48 rounded-[15px] bg-white shadow-xl ring-1 ring-black ring-opacity-5 overflow-y-auto border border-gray-100">
                            <div class="py-2">
        ...
        <div class="flex flex-col gap-4">
            <div class="flex items-center justify-between mb-2">
                <h2 class="text-2xl font-bold">Sedang Dipinjam</h2>
                <div class="flex items-center gap-2">
                    <div class="h-2 w-2 bg-blue-500 rounded-full"></div>
                    <span class="text-sm text-gray-500">{{ $dipinjam->count() }} Peminjaman</span>
                </div>
            </div>
            ...
            <form method="GET" action="{{ route('peminjam-peminjaman') }}" class="mb-2">
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <div x-data="{ open: false }" class="relative inline-block text-left">
                        ...
                        <div x-show="open" @click.outside="open = false" style="display:none" x-transition.opacity class="max-h-[250px] absolute right-0 z-[100] mt-2 w-56 rounded-[15px] bg-white shadow-xl ring-1 ring-black ring-opacity-5 overflow-y-auto border border-gray-100">
                            <div class="py-2">
    ...
    <div class="mt-8">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-2xl font-bold">Riwayat Selesai & Ditolak</h2>
            <div class="flex items-center gap-2">
                <div class="h-2 w-2 bg-green-500 rounded-full"></div>
                <span class="text-sm text-gray-500">{{ $riwayat->total() }} Peminjaman</span>
            </div>
        </div>
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <div x-data="{ open: false }" class="relative inline-block text-left">
                    ...
                    <div x-show="open" @click.outside="open = false" style="display:none" x-transition.opacity 
                        class="absolute right-0 z-[100] mt-2 w-56 rounded-[15px] bg-white shadow-xl ring-1 ring-black ring-opacity-5 overflow-y-auto border border-gray-100">
                        <div class="py-2">
                            <p class="px-4 py-2 text-xs font-bold text-gray-500 mb-1">Filter Status</p>
                            <label class="flex items-center px-4 py-2.5 text-sm text-[#363062] hover:bg-gray-50 cursor-pointer transition">
