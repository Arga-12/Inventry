		...
		<div class="h-36 w-full bg-white flex flex-shrink-0 flex-col col-span-3 items-stretch justify-between gap-4 p-6 shadow-lg rounded-[20px]">
			...
			<div class="flex items-stretch justify-between h-full w-full">
				<div class="flex items-center gap-2">
					<div class="h-10 w-24 border border-[#363062] rounded-full p-4 flex items-center justify-center">
						<p class="text-[#363062] font-normal text-sm">filter1</p>
					</div>
					<div class="h-10 w-24 border border-[#363062] rounded-full p-4 flex items-center justify-center">
						<p class="text-[#363062] font-normal text-sm">filter2</p>
					</div>
					<div class="h-10 w-24 border border-[#363062] rounded-full p-4 flex items-center justify-center">
						<p class="text-[#363062] font-normal text-sm">filter3</p>
					</div>
				</div>
				...
				<div class="flex gap-2 items-center">
					...
					<button class="h-10 w-32 p-4 bg-[#363062] flex items-center justify-center text-white font-normal rounded-[20px]">
						Cari
					</button>
				</div>
			</div>
