		...
		<form method="GET" action="{{ route('admin-pengembalian') }}">
			<div class="flex justify-between items-center">
				<div class="flex items-center gap-3 flex-wrap">
					...
					{{-- HIDDEN FIELDS UNTUK MENGOSONGKAN FILTER SELESAI --}}
					...
					<a href="{{ route('admin-pengembalian') }}" class="px-4 py-3 text-sm text-[#363062]/90 hover:text-[#363062] border border-[#363062] rounded-full transition font-semibold">
						Reset Filter
					</a>
					@endif
				...
				<div class="flex items-center gap-3">
					<a href="{{ route('admin-pengembalian-create') }}" class="px-4 py-3 flex items-center gap-2 border border-transparent text-white font-semibold rounded-full text-sm bg-[#363062] group hover:bg-transparent hover:text-[#363062] hover:border-[#363062] transition-all">
				...
				<div class="flex items-start justify-between">
					...
					<div class="flex items-center gap-2">
						<div class="w-8 h-8 rounded-full overflow-hidden">
							<img src="{{ $pengembalian->peminjaman->peminjam->foto_url }}" class="w-full h-full object-cover">
						</div>
						<div class="text-sm">
							<p class="font-medium">
			...
			<div class="flex justify-between items-center">
				<div class="flex items-center gap-3 flex-wrap">
					...
					<div x-data="{ open: false }" class="relative inline-block text-left">
						...
						<div x-show="open" @click.outside="open = false" style="display:none" x-transition.opacity
							class="max-h-[350px] absolute left-0 z-20 mt-2 w-64 rounded-[15px] bg-white shadow-xl ring-1 ring-black ring-opacity-5 overflow-y-auto border border-gray-100">
							<div class="py-2">
					...
					<a href="{{ route('admin-pengembalian') . '#selesai' }}" class="px-4 py-3 text-sm text-[#363062]/90 hover:text-[#363062] border border-[#363062] rounded-full transition font-semibold">
						Reset Filter
					</a>
					@endif
