...
<div class="mx-auto py-8 px-4">
    <div class="w-full flex flex-col gap-10">
        ...
        <div class="flex flex-col">
            ...
            <p class="text-gray-500">Edit data user yang sudah ada</p>
        </div>

        {{-- FORM --}}
        <form action="{{ route('admin-pengguna-update', $pengguna) }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-10">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <p class="text-gray-500 text-sm">Edit data diri user</p>
                </div>
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div class="flex flex-col flex-1 gap-4 w-full">
                            ...
                            <div class="flex flex-col gap-2 flex-1">
                                ...
                                <input type="text" name="username" value="{{ old('username', $pengguna->username) }}" placeholder="Masukkan username..." class="w-full border border-gray-400 rounded-xl px-4 py-3 bg-white focus:outline-none focus:border-[#363062] @error('username') border-red-500 @enderror">
                                @error('username')
                            ...
                            <div class="flex flex-col gap-2 flex-1">
                                ...
                                <input type="text" name="nama_lengkap" value="{{ old('nama_lengkap', $pengguna->nama_lengkap) }}" placeholder="Masukkan nama lengkap..." class="w-full border border-gray-400 rounded-xl px-4 py-3 bg-white focus:outline-none focus:border-[#363062] @error('nama_lengkap') border-red-500 @enderror">
                                @error('nama_lengkap')
                                <p class="text-red-500 text-xs">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="email" name="email" value="{{ old('email', $pengguna->email) }}" placeholder="Masukkan email..." class="w-full border border-gray-400 rounded-xl px-4 py-3 bg-white focus:outline-none focus:border-[#363062] @error('email') border-red-500 @enderror">
                        @error('email')
                        <p class="text-red-500 text-xs">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <select name="role" class="w-full border border-gray-400 rounded-xl px-4 py-3 bg-white focus:outline-none focus:border-[#363062] @error('role') border-red-500 @enderror">
                            ...
                            <option value="peminjam" {{ old('role', $pengguna->role) == 'peminjam' ? 'selected' : '' }}>Peminjam</option>
                        </select>
                        @error('role')
                        <p class="text-red-500 text-xs">{{ $message }}</p>
                        @enderror
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="password" name="password" placeholder="Masukkan password baru (minimal 6 karakter)..." class="w-full border border-gray-400 rounded-xl px-4 py-3 bg-white focus:outline-none focus:border-[#363062] @error('password') border-red-500 @enderror">
                        @error('password')
                        <p class="text-red-500 text-xs">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="password" name="password_confirmation" placeholder="Ulangi password baru..." class="w-full border border-gray-400 rounded-xl px-4 py-3 bg-white focus:outline-none focus:border-[#363062]">
                    </div>

                    <div class="bg-[#F99417]/50 border border-[#F99417] rounded-xl p-3">
                        <p class="text-xs text-yellow-800">
                            <span class="font-semibold">Catatan:</span> Biarkan kosong jika tidak ingin mengubah password.
                        </p>
                    </div>
