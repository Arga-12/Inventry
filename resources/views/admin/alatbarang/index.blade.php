...
<div class="mx-auto py-8 px-4">
				...
				<form action="{{ route('admin-alat') }}" method="GET" class="flex items-center gap-3 flex-wrap">
					<div class="relative flex-1 w-full h-full flex-shrink-0">
						<div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
							<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" viewBox="0 0 24 24"><path fill="currentColor" d="M18 10c0-4.41-3.59-8-8-8s-8 3.59-8 8s3.59 8 8 8c1.85 0 3.54-.63 4.9-1.69l5.1 5.1L21.41 20l-5.1-5.1A8 8 0 0 0 18 10M4 10c0-3.31 2.69-6 6-6s6 2.69 6 6s-2.69 6-6 6s-6-2.69-6-6"/></svg>
						</div>
						<input 
							type="text" 
							name="search_stok" 
					...
					<div class="flex h-36 bg-white border border-gray-200 rounded-[20px] overflow-hidden shadow-sm hover:shadow-lg transition">
						...
						<div class="w-2/3 p-4 flex flex-col justify-between">
							...
							<div class="flex items-center justify-between">
								...
								<div class="flex items-center gap-2">
									<a href="{{ route('admin-alat-edit', $data) }}" class="text-xs px-3 py-1 border border-[#F99417] text-[#F99417] rounded-full hover:bg-[#F99417] hover:text-white transition">
										Edit
									</a>
									
									<form action="{{ route('admin-alat-destroy', $data) }}" method="POST" class="inline">
										@csrf
										@method('DELETE')
	...
	<div class="lg:col-span-3">
		<div class="w-full flex flex-col gap-6">
			...
			<h2 class="font-bold text-3xl pt-10">Daftar Alat & Barang</h2>
			...
			<div class="w-full overflow-x-auto grid grid-cols-3 gap-10">
				...
				<div class="w-full h-[400px]">
					<div class="relative w-full h-full bg-white rounded-[20px] p-4 overflow-hidden shadow-lg">
						<img src="{{ asset('storage/' . $data->gambar) }}" alt="gambar alat" class="absolute inset-0 w-full h-full object-cover object-center">					
