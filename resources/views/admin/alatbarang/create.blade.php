				...
				<div x-data="{ preview: null }">
					...
					<label class="group w-full h-64 border border-gray-300 rounded-3xl flex flex-col items-center justify-center bg-gray-100 hover:bg-gray-200 transition cursor-pointer overflow-hidden relative">
						...
						>
							...
							<svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mb-3" :class="preview ? 'text-white' : 'text-gray-500'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
			...
			<div class="flex flex-col gap-6">
				...
				<div class="flex flex-col gap-2">
					...
					<select name="kategori_id" class="w-full border border-gray-400 rounded-xl px-4 py-2.5 sm:py-3 bg-white text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#363062] transition-shadow">
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
			...
			<div class="flex flex-col gap-6">
				...
				<div class="flex flex-col gap-2">
					...
					type="number"
					name="stok"
					class="w-full border border-gray-400 rounded-xl px-4 py-2.5 sm:py-3 bg-white text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#363062] transition-shadow resize-none"
					></input>
				</div>
				...
				<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
					...
					<div class="flex flex-col items-center justify-center gap-2">
						<div class="w-full h-full text-left border border-gray-400 rounded-xl px-4 py-2.5 sm:py-3 bg-white text-xs sm:text-sm">
